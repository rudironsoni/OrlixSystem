...
The public product API is bootloader-shaped only. It exposes a minimal boot entrypoint with a closed profile selection and opaque app-level resource identifiers.
...
The bootloader translates app-level inputs into Linux-shaped boot data.
