...
Generated from vendored Linux UAPI and `IXLandKernel/runtime/syscall.c`.
...
| 117 | `ptrace` | implemented:process | `IXLandKernelTests/PtraceContract.c`, `IXLandKernelTests/PtraceTests.m` |
