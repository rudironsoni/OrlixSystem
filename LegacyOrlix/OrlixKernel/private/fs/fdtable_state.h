...
void init_synthetic_subdir_fd_entry_impl(int fd, int flags, uint32_t mode, const char *path,
...
void init_synthetic_dev_fd_entry_impl(int fd, int flags, uint32_t mode, const char *path,
...
void init_synthetic_proc_file_fd_entry_impl(int fd, int flags, uint32_t mode, const char *path,
...
void init_synthetic_cgroupfs_file_fd_entry_impl(int fd, int flags, uint32_t mode,
                                                ...
                                                int cgroup_node);
void init_synthetic_proc_file_fd_entry_for_pid_impl(int fd, int flags, uint32_t mode,
                                                    const char *path,
                                                    synthetic_proc_file_t proc_file,
                                                    int target_pid);
void init_synthetic_proc_file_fd_entry_with_fdnum_impl(int fd, int flags, uint32_t mode,
                                                       const char *path,
                                                       synthetic_proc_file_t proc_file,
                                                       int fd_num);
void init_synthetic_proc_file_fd_entry_with_fdnum_for_pid_impl(int fd, int flags,
                                                               uint32_t mode, const char *path,
                                                               synthetic_proc_file_t proc_file,
                                                               int fd_num, int target_pid);
