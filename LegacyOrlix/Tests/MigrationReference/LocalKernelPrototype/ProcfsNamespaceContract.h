#ifndef ORLIXSYSTEMLINUXKERNELTESTS_PROCFSNAMESPACECONTRACT_H
#define ORLIXSYSTEMLINUXKERNELTESTS_PROCFSNAMESPACECONTRACT_H
...
#endif /* ORLIXSYSTEMLINUXKERNELTESTS_PROCFSNAMESPACECONTRACT_H */
