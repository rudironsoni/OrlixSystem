#ifndef ORLIXSYSTEMLINUXKERNELTESTS_SECCOMPCONTRACT_H
#define ORLIXSYSTEMLINUXKERNELTESTS_SECCOMPCONTRACT_H
...
#endif /* ORLIXSYSTEMLINUXKERNELTESTS_SECCOMPCONTRACT_H */
